(function () {
  ...
  const questionBank = [
    // Dasar: KPK yang umum digunakan saat mulai belajar pecahan.
    [1, 2, 1, 3], [1, 2, 1, 4], [2, 3, 1, 4], [1, 3, 1, 6], [1, 4, 1, 6], [2, 5, 1, 10],
    [1, 6, 3, 8], [1, 6, 1, 9], [1, 8, 1, 12], [2, 9, 1, 6], [3, 10, 1, 5], [1, 4, 1, 12],

    // Hasil pada kelompok ini sebagian besar perlu disederhanakan.
    [1, 2, 1, 6], [1, 3, 1, 9], [1, 4, 1, 8], [2, 3, 1, 6], [3, 4, 1, 8], [2, 5, 2, 10],
    [3, 8, 1, 4], [1, 9, 2, 3], [5, 6, 1, 12], [2, 9, 1, 3], [1, 6, 1, 12], [3, 5, 1, 10],

    // Penerapan: KPK lebih bervariasi, termasuk hasil lebih dari satu.
    [3, 4, 2, 3], [5, 6, 3, 4], [7, 8, 2, 3], [5, 12, 3, 8], [3, 5, 1, 4], [4, 9, 1, 4],
    [7, 10, 1, 3], [5, 8, 1, 6], [5, 9, 1, 6], [7, 12, 1, 8], [3, 7, 1, 2], [5, 7, 1, 4]
