(function () {
  ...
  const questionBank = [
    ...
    { mathml: multiply(power("x", -2), power("x", -3)), label: "x pangkat negatif 2 kali x pangkat negatif 3", answer: fractionPowerOption("x", 5), distractors: [powerOption("x", 5), fractionPowerOption("x", 4), fractionPowerOption("x", 6)] },
    { mathml: multiply(power("a", -4), power("a", -2)), label: "a pangkat negatif 4 kali a pangkat negatif 2", answer: fractionPowerOption("a", 6), distractors: [powerOption("a", 6), fractionPowerOption("a", 5), fractionPowerOption("a", 8)] },
